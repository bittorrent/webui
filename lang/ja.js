...
var LANG_STR =
{
   ...
   "DLG_SETTINGS_10_REMOTE_02":"BitTorrent Remote は、ブラウザーを通してクライアントにアクセスする、安全性の高い簡単な方法を提供します。",
   "DLG_SETTINGS_10_REMOTE_03":"次の接続を有効にして、コンピューター名とパスワードを選択し、忘れずにこのコンピューターの電源を入れたままにしておくだけです。",
   "DLG_SETTINGS_10_REMOTE_04":"もっと詳しく",
   "DLG_SETTINGS_10_REMOTE_05":"BitTorrent Remote Access を使用する",
   "DLG_SETTINGS_10_REMOTE_06":"認証",
   "DLG_SETTINGS_10_REMOTE_07":"コンピューター名:",
   "DLG_SETTINGS_10_REMOTE_08":"パスワード:",
   "DLG_SETTINGS_10_REMOTE_09":"送信",
