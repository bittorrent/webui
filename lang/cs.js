...
var LANG_STR = [
	...
	null,
	"BitTorrent Remote",
	"BitTorrent Remote přináší jednoduchý a vysoce bezpečný způsob přístupu k vašemu klientovi přes prohlížeč.",
	"Stačí jen povolit připojení níže, zadat název počítače a heslo a pamatovat si, že počítač musí zůstat zapnutý.",
	"Více informací",
	"Povolit vzdálený přístup BitTorrent Remote",
	"Ověření uživatele",
	"Jméno:",
	"Heslo:",
	"Odeslat",
