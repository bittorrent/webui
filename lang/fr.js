...
,"Limiter l'accès à ces adresses IP (séparer les différentes entrées par une virgule) :"
	...
	"Préférences",
	"BitTorrent Remote",
	"BitTorrent Remote permet d'accéder facilement et de manière sécurisée à votre client depuis un navigateur.",
	"Activez simplement la connexion ci-dessous, choisissez un nom d'ordinateur et un mot de passe et rappelez-vous de laisser cet ordinateur allumé.",
	"En savoir plus",
	"Activer l'accès à distance à BitTorrent",
	"Authentification",
	"Identifiant:",
	"Mot de passe:",
	"Soumettre",
	...
	"Vous devez entrer un mot de passe pour utiliser BitTorrent Remote",
	"N'a pas pu contacter le service BitTorrent Remote pour s'enregistrer",
	"Un autre ordinateur utilise déjà le nom d'utilisateur",
	"Les noms d'utilisateurs ne peuvent comporter des caractères accentués",
	"Le mot de passe ne peut pas contenir des caractères spéciaux",
	"Statut: "
	];
