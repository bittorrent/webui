...
var LANG_STR =
{
   ...
   "DLG_SETTINGS_1_GENERAL_20":"활성 토렌트가 있으면 대기 상태 안 들어감(E)",
   "DLG_SETTINGS_2_UI_01":"옵션 표시",
   "DLG_SETTINGS_2_UI_02":"토렌트 삭제시 확인(O)",
   ...
   "DLG_SETTINGS_2_UI_15":"토렌트를 추가할 때",
   ...
   "DLG_SETTINGS_3_PATHS_07":"디렉토리 이름 끝에 토렌트 라벨명 삽입(A)",
   "DLG_SETTINGS_3_PATHS_10":"기본 다운로드 디렉토리에서만 이동(O)",
   "DLG_SETTINGS_3_PATHS_11":"토렌트 파일의 위치",
   "DLG_SETTINGS_3_PATHS_12":"토렌트 파일의 저장 위치:",
   "DLG_SETTINGS_3_PATHS_15":"완료된 작업의 토렌트 파일 이동 위치:",
   "DLG_SETTINGS_3_PATHS_18":"자동 올림 토렌트 파일의 위치(A)",
   "DLG_SETTINGS_3_PATHS_19":"올린 토트 파일 삭제(D)",
   ...
   "DLG_SETTINGS_7_TRANSFERCAP_01":"Transfer Cap 활성화",
   "DLG_SETTINGS_7_TRANSFERCAP_02":"Transfer Cap 설정",
   ...
   "DLG_SETTINGS_8_QUEUEING_02":"최대 활성 토렌트 (업/다운 모두):",
   ...
   "DLG_SETTINGS_8_QUEUEING_12":"토트가 배포 목표에 도달하면",
   ...
   "DLG_TORRENTPROP_1_GEN_12":"최소 비율 (%):",
   "DLG_TORRENTPROP_1_GEN_14":"최소 시드 시간 (분):",
   ...
   "DLG_RSSDOWNLOADER_34":"RSS 피드 제거",
   "DLG_RSSDOWNLOADER_35":"선택된 %d 개의 RSS 피드를 삭제하겠습니까?",
   "DLG_RSSDOWNLOADER_36":"RSS 항목 \"%s\"을(를) 삭제하겠습니까?",
   ...
   "OV_COL_UPPED":"업로드",
   "OV_COL_UPSPD":"업 속도",
   "OV_CONFIRM_DELETEDATA_MULTIPLE":"%d 개의 선택된 토렌트와 데이터를 삭제하시겠습니까?",
   "OV_CONFIRM_DELETEDATA_ONE":"선택된 토렌트와 데이터를 삭제하시겠습니까?",
   "OV_CONFIRM_DELETE_MULTIPLE":"%d 개의 선택된 토렌트를 삭제하시겠습니까?",
   "OV_CONFIRM_DELETE_ONE":"선택된 토렌트를 삭제하시겠습니까?",
   "OV_CONFIRM_DELETE_RSSFILTER":"RSS 필터 \"%s\"을(를) 삭제하시겠습니까??",
   "OV_FL_CHECKED":"검사 %:.1d%",
   ...
   "OV_NEWLABEL_TEXT":"선택한 토렌트의 새 라벨을 입력하세요:",
   "OV_NEW_LABEL":"새 라벨...",
   "OV_REMOVE_LABEL":"라벨 제거",
   "OV_TABS":"일반||트래커||피어||조각||파일||속도||기록||",
   "OV_TB_ADDTORR":"토렌트 추가",
   "OV_TB_ADDURL":"주소에서 토렌트 추가",
   "OV_TB_PAUSE":"일시정지",
   "OV_TB_PREF":"설정",
   ...
   "MM_HELP_WEBUI_FEEDBACK":"WebUI 피드백 보내기",
   ...
   "ST_SCH_LGND_OFF":"끄기",
   "ST_SCH_LGND_OFFEX":"종료 - 지정하지 않은 모든 토렌트 중지",
