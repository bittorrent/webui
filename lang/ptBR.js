...
,"Permite acesso apenas a partir desses IPs (separe as entradas com uma vírgula)"
	...
	null,
	"BitTorrent Remoto",
	"BitTorrent Remoto oferece uma maneira fácil e segura de acessar seu cliente através de um navegador.",
	"Apenas habilite a conexão abaixo, escolha um nome do computador e senha, e lembre-se de deixar o PC ligado.",
	"Saiba Mais",
	"Habilitar Acesso BitTorrent Remoto",
	"Autenticação",
	"Usuário:",
	"Senha:",
	"Enviar",
	...
	"Não acessível",
	"Registro falhou",
	"Você precisa digitar uma senha para usar o BitTorrent Remoto",
	"Não foi possível contactar o serviço BitTorrent Remoto para registrar",
	"Já existe um computador usando este usuário",
	"Nome de usuário não pode conter caracteres especiais ou centuados",
	"A senha não pode conter caracteres especiais ou centuados",
	"Status: "
];
