...
var LANG_STR = [
	...
	null,
	null,
	"יוטורנט בשליטה מרחוק",
	"יוטורנט שליטה מרחוק מספק דרך קלה ובטוחה של גישה ללקוח שלך דרך דפדפן.",
	"רק אפשר את החיבורים למטה, בחר שם מחשב וסיסמה ותזכור להשאיר את המחשב דלוק.",
	"למד עוד",
	"אפשר שליטה מרחוק על יוטורנט",
	"אימות",
	"שם משתמש:",
	"סיסמה:",
	"שלח",
