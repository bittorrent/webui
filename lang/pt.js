...
var LANG_STR = [
	...
	null,
	"BitTorrent Remoto",
	"O BitTorrent Remoto fornece uma maneira fácil e segura de aceder ao seu cliente através de um navegador.",
	"Ative apenas a conexão em baixo, escolha um nome de computador e senha, e deixe este computador ligado.",
	"Saber Mais",
	"Ativar Acesso BitTorrent Remoto",
	"Autenticação",
	"Utilizador:",
	"Senha:",
	"Submeter",
	...
	"Inacessível",
	"Registo falhado",
	"Tem que indicar uma senha para usar o BitTorrent Remoto",
	"Não foi possível contactar o serviço BitTorrent Remoto para registar",
	"Já existe um computador a usar este nome de utilizador",
	"Os nomes de utilizador não podem conter carateres não-Ingleses",
	"A senha não pode conter carateres não-Ingleses",
	"Estado: "
];
