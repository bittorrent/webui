...
var LANG_STR = [
	...
	null,
	null,
	"Віддалений BitTorrent",
	"Віддалений BitTorrent надає легкий та надзвичайно безпечний спосіб доступу до клієнта за допомогою веб-браузера",
	"Всього лиш дозвольте з'єднання, оберіть назву комп'ютера та пароль та не забудьте залишити цей ПК увімкнутим.",
	"Дізнатися більше",
	"Увімкнути доступ до Віддаленого BitTorrent'у",
	"Аутентифікація",
	"Ім'я:",
	"Пароль:",
	"Відіслати",
