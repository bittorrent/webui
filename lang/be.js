...
var LANG_STR = [
	...
	null,
	"Падалены BitTorrent",
	"BitTorrent Remote дае лёгкі і вельмі бяспечны шлях да вашага кліента праз аглядальнік.",
	"Проста ўключыце паданае ніжэй злучэнне, абярыце назву кампутара і пароль, і пакіньце гэты кампутар уключаным.",
	"Падрабязнасці",
	"Дазволіць падалены доступ да BitTorrent",
	"Аўтэнтыфікацыя",
	"Імя:",
	"Пароль:",
	"Гатова",
