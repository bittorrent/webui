...
,"Разрешить доступ только с этих IP-адресов (разделяются запятой):"
	...
	null,
	"Настройки",
	"Удалённый BitTorrent",
	"Удалённый BitTorrent обеспечивает простой и безопасный способ доступа к клиенту через браузер.",
	"Просто включите ниже параметр 'Доступ...', выберите компьютер и пароль, и не забудьте оставить компьютер включённым.",
	"Подробнее",
	"Доступ к удалённому BitTorrent",
	"Аутентификация",
	"Имя:",
	"Пароль:",
	"Отправить",
	...
	"недоступно",
	"ошибка регистрации",
	"Чтобы воспользоваться удалённым BitTorrent, нужно ввести пароль",
	"Невозможно связаться со службой регистрации удалённого BitTorrent",
	"Уже имеется компьютер с именем пользователя",
	"В имени пользователя должны быть только английские буквы",
	"В пароле должны быть только английские буквы",
	"Статус: "
];
